...
ENTRY_THRESHOLDS_SPACE = {
    ...
    "two_zones_v2": t_two_zones_v2,
    "two_zones_soft": t_two_zones_soft,
    "two_zones_convex": t_two_zones_convex,
    "two_zones_defensive": t_two_zones_defensive,
