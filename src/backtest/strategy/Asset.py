...
class Asset:
    ...
    def __create_buy(self, t, amount, qty, dd):
        return {
            "index": t,
            "ticker": self.ticker,
            "price": self.prices[t],
    ...
    def __add_buy(self, amount_eur, t, dd):
